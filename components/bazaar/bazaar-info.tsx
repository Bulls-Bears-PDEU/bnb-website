...
export default function BazaarInfo() {
  ...
  return (
			<section
				id="bazaar-info"
				className="bg-muted/30 py-24 dark:bg-muted/10"
				ref={ref}
			>
				<div className="container px-4">
					...
					>
						...
						<p className="mx-auto max-w-3xl text-lg text-muted-foreground">
							Bazaar is Bulls & Bears' flagship event that simulates real-world
							financial markets. Participants trade virtual stocks in a dynamic
							environment that reacts to real-time market conditions and
						...
						<div className="grid gap-6 md:grid-cols-3">
							<div className="rounded-lg bg-card/50 p-4 backdrop-blur-sm">
								...
								<p className="text-sm text-foreground/80">
									Workshops and sessions by industry experts to understand
									market dynamics
								</p>
							</div>
							<div className="rounded-lg bg-card/50 p-4 backdrop-blur-sm">
								...
								<p className="text-sm text-foreground/80">
									Hands-on trading experience with our sophisticated simulation
									platform
								</p>
							</div>
							<div className="rounded-lg bg-card/50 p-4 backdrop-blur-sm">
								...
								<p className="text-sm text-foreground/80">
									Connect with finance professionals and like-minded students
								</p>
							</div>
						</div>
					</motion.div>
