...
export default function EventsHero() {
  // Target event date
		const nextEventDate = new Date(events[4].dateTime);
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We only want to set up the timer once on mount
		useEffect(() => {
					...
					<div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
						...
						>
							...
							<p className="mb-8 text-muted-foreground">
								From market simulations to expert-led seminars, our events
								provide hands-on experience and valuable insights into the world
								of finance.
							</p>
