			...
			<div className="container px-4 py-12">
				<div className="grid gap-8 md:grid-cols-3">
					<div className="space-y-4">
						...
						<p className="text-sm text-muted-foreground">
							The Finance Club of Pandit Deendayal Energy University, dedicated
							to fostering financial literacy and market understanding.
						</p>
					</div>
				...
				<div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 text-center sm:flex-row sm:text-left">
					<p className="text-xs text-muted-foreground">
						&copy; {new Date().getFullYear()} Bulls & Bears Finance Club. All
						rights reserved.
					</p>
					<motion.p
						animate={{ x: [0, 10, 0] }}
					...
					>
						Designed by Bhaumik Patel, Maintained by Aaryan Patel
					</motion.p>
				</div>
			</div>
		</footer>
