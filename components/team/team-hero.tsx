					...
					<div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
						...
						>
							...
							<p className="mb-6 text-xl text-foreground/80">
								The passionate individuals driving Bulls & Bears Finance Club
								forward
							</p>
							<p className="mb-8 text-muted-foreground">
								Our team consists of dedicated students with a shared passion
								for finance and economics, working together to create valuable
